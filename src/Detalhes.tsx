    ...
    <div className="bg-[#10100F] pt-8 h-[93.3vh]">
      <section className="flex mx-auto flex-col w-[40rem] items-start border p-5 border-gray-200 rounded-lg shadow md:max-w-5xl dark:border-gray-700 dark:bg-[#050504]">
        ...
        <div className="flex flex-col justify-between py-4 leading-normal">
          ...
          <div>
            <h5 className="text-[1.1rem] tracking-tight text-[#ccc] dark:text-[#ccc]">
          ...
          <p className="my-3 font-normal text-[#ccc] dark:text-gray-400">
            {curso?.descricao}
          </p>
          {cliente.id ?
            <>
            ...
            :
            <h2 className="mb-2 text-xl tracking-tight text-[#ccc] dark:text-white">
              📢 Se interressou pelo nosso Curso? <Link to="/cadCliente" className="text-blue-500">Cadastre-se</Link> agora e tire suas duvidas conosco!
            </h2>
          }
        </div>
      </section>
