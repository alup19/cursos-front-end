...
export default function Detalhes() {
  ...
  return (
    <div className="bg-[#10100F] pt-8 h-[93.3vh]">
      <section className="flex mx-auto flex-col w-[40rem] items-start border-[#1C1B1D] border-[3px] p-5 rounded-lg shadow md:max-w-5xl">
        ...
        <div className="flex flex-col justify-between py-4 leading-normal">
          <div className="flex flex-row justify-between w-[37rem]">
