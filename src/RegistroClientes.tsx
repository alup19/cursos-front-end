                    ...
                    <form action="" className="flex flex-col gap-8 items-center">
                        <div className='flex flex-row gap-12'>
                            <div className='flex flex-col'>
                                ...
                                <input type="text" name="" id="" className="text-white px-2 w-[14.875rem] h-[2.25rem] bg-[#0F0F0E] border-[2px] border-[#292727] rounded-[0.56rem]" />
                            </div>
                            <div className='flex flex-col'>
                                <label htmlFor="" className="text-[#756D6D] text-[0.9375rem]font-inter">Email</label>
                                <input type="email" name="" id="" className="text-white px-2 w-[14.875rem] h-[2.25rem] bg-[#0F0F0E] border-[2px] border-[#292727] rounded-[0.56rem]" />
                            </div>
                        </div>
                        <div className='flex flex-row gap-12'>
                            <div className='flex flex-col'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <input type="tel" name="" id="" className="text-white px-2 w-[14.875rem] h-[2.25rem] bg-[#0F0F0E] border-[2px] border-[#292727] rounded-[0.56rem]" placeholder="(00) 0000-0000"
                        ...
                        <div className='flex flex-row gap-12'>
                            <div className='flex flex-col'>
                                ...
                                <input type="password" name="" id="" className="text-white px-2 w-[14.875rem] h-[2.25rem] bg-[#0F0F0E] border-[2px] border-[#292727] rounded-[0.56rem]" />
                            </div>
                            <div className='flex flex-col'>
                        ...
                        <input type="submit" value="Registrar-se" className="text-white bg-gradient-to-r from-[#245A7C] to-[#42A4E2] rounded-[0.6875rem] w-[14.8125rem] h-[2.375rem] text-[1.25rem] font-inter font-bold leading-normal cursor-pointer mt-[1.31rem] mb-[1.31rem]" />
                    </form>
